...
<legend><strong>TRABAJADORES</strong></legend>
    ...
    if ($resultado = mysqli_query($conexion, $consulta)) {
        ...
        <table border='0' width='600' style='font-family: Verdana; font-size: 8pt' id='table1'>
            <tr>
                <td colspan='2'><h3 align='center'>Borrar trabajador</h3></td>
            </tr>
            <tr>
            ...
            <form method='POST' action='borrar3.php'>
                ...
                <tr>
                    ...
                    <td width='50%'><p align='center'><input type='text' name='nombre' size='20' value='" . $row['nombre_emp'] . "'disabled='disabled' ></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Apellidos</b></td>
                    <td width='50%'><p align='center'><input type='text' name='apellido' size='20' value='" . $row['apellido_emp'] . "' disabled='disabled'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Correo</b></td>
                    <td width='50%'><p align='center'><input type='text' name='correo' size='20' value='" . $row['correo_emp'] . "'disabled='disabled'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Direccion</b></td>
                    <td width='50%'><p align='center'><input type='text' name='direccion' size='20' value='" . $row['direccion_emp'] . "'disabled='disabled'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Telefono</b></td>
                    <td width='50%'><p align='center'><input type='text' name='telefono' size='20' value='" . $row['telefono_emp'] . "'disabled='disabled'></td>
                </tr>
                <tr>
                    <td width='50%'>&nbsp;</td>
                    <td width='50%'>&nbsp;</td>
