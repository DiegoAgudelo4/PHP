        ...
        <table border='0' width='600' style='font-family: Verdana; font-size: 8pt' id='table1'>
            ...
            <form method='POST' action='actualizar3.php'>
                ...
                <tr>
                    ...
                    <td width='50%'><p align='center'><input type='text' name='nombre' size='20' value='" . $row['nombre_cl'] . "'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Apellidos</b></td>
                    <td width='50%'><p align='center'><input type='text' name='apellido' size='20' value='" . $row['apellido_cl'] . "'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Correo</b></td>
                    <td width='50%'><p align='center'><input type='text' name='correo' size='20' value='" . $row['correo_cl'] . "'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Direccion</b></td>
                    <td width='50%'><p align='center'><input type='text' name='direccion' size='20' value='" . $row['direccion_cl'] . "'></td>
                </tr>
                <tr>
                    <td width='50%'><p align='center'><b>Telefono</b></td>
                    <td width='50%'><p align='center'><input type='text' name='telefono' size='20' value='" . $row['telefono_cl'] . "'></td>
                </tr>
                <tr>
                    <td width='50%'>&nbsp;</td>
                    <td width='50%'>&nbsp;</td>
